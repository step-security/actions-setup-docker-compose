...
<a href="https://github.com/step-security/actions-setup-docker-compose/actions"><img alt="actions-setup-docker-compose status" src="https://github.com/step-security/actions-setup-docker-compose/workflows/build-test/badge.svg"></a>
...
```yml
  steps:
  - uses: step-security/actions-setup-docker-compose@v1
    with:
